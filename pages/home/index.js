      ...
      {/* <div className="mx-6 bg-indigo-500 border-b rounded-b-xl ">
        <div className="w-12/12 flex items-center justify-between mx-auto px-4 rounded-lg py-2">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-800 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Create New Startup
          </button>
        </div>
