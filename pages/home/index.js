...
import StartupCard from "../../components/home-components/StartupCard";
    ...
    <div className="bg-white">
      <div className="flex flex-wrap">
            ...
            >
              <li className=" flex-auto text-center">
                <a
                  className={
                    ...
                    (openTab === 1 ? "text-indigo-300" : "text-gray-300")
                  }
                  onClick={(e) => {
                    e.preventDefault();
                    setOpenTab(1);
              ...
              <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a
                  className={
                    "text-lg font-bold px-5 py-2 block leading-normal  " +
                    (openTab === 2 ? "text-indigo-300 " : "text-gray-300")
                  }
                  onClick={(e) => {
                    e.preventDefault();
                    setOpenTab(2);
        ...
        <div
          ...
          class="md:w-1/3 w-full bg-gray-700 "
        >
            ...
            <ul className="flex list-none flex-wrap flex-row" role="tablist">
              <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a
                  className={
                    ...
                    (openIdeaTab === 1 ? "text-blue-300" : "text-gray-100")
                  }
                  onClick={(e) => {
                    e.preventDefault();
                    setopenIdeaTab(1);
              ...
              <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a
                  className={
                    "text-md font-bold uppercase px-5 py-3 block leading-normal  " +
                    (openIdeaTab === 2 ? "text-blue-300 " : "text-gray-300")
                  }
                  onClick={(e) => {
                    e.preventDefault();
                    setopenIdeaTab(2);
              ...
              <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                <a
                  className={
                    "text-md font-bold uppercase px-5 py-3 block leading-normal " +
                    (openIdeaTab === 3 ? "text-blue-300" : "text-gray-100")
                  }
                  onClick={(e) => {
                    e.preventDefault();
                    setopenIdeaTab(1);
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 xl:grid-cols-1 p-2 bg-gray-600 rounded-t-2xl">
            <div class="px-2 ">
              <a class="flex items-center py-3 -mx-2 transition-colors duration-300 transform border-b hover:bg-gray-700 border-gray-700">
                ...
                <p class="text-gray-200">
                  ...
                  <e>
                    The value for the textbox must be chosen from a predefined
                    set of allowed values, e.g., a location field must contain a
                    valid location name
                  </e>
                </p>
              </a>
