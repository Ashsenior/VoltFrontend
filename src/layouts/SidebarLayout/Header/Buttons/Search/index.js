        ...
        {openSearchResults && (
          <DialogContent>
            ...
            >
              ...
              <Link href="src/layouts/SidebarLayout/Header/Buttons/Search/index#" variant="body2" underline="hover">
                Advanced search
              </Link>
            </Box>
            <Divider sx={{ my: 1 }} />
              ...
              <ListItem button>
                ...
                <Box flex="1">
                  <Box display="flex" justifyContent="space-between">
                    <Link
                      href="src/layouts/SidebarLayout/Header/Buttons/Search/index#"
                      underline="hover"
                      sx={{ fontWeight: 'bold' }}
                      variant="body2"
                    >
