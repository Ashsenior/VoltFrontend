...
const InProgressStrategy = ({ data }) => {
    ...
    return (
        <div className='bg-gray-900 shadow-xl rounded-lg mt-2 p-4'>
            ...
            <div className='py-2'>
                <a href="#xc" className='flex items-center text-gray-300 mt-1 bg-gray-800 hover:bg-gray-500 hover:text-gray-100 gap-1'>
                ...
                <a href="#xc" className='flex items-center  mt-1 bg-gray-800 gap-1 hover:bg-gray-500 hover:text-gray-100'>
