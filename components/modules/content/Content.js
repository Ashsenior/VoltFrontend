    ...
    <div className="border-b p-4">
      <div className="flex justify-between">
        <div className="flex flex-col items-start justify-start">
          ...
          >
            <AssignmentOutlinedIcon className="text-gray-500" /> {content.title}
          </p>
        ...
        <div className="flex flex-col ml-1 font-bold items-end justify-between">
          <p>
            <small className="text-gray-500">deadline</small> {content.date}
          </p>
          <span
            onClick={() => Router.push("/module/create_content/ContentDetails")}
            className="bg-gray-600 rounded-md text-gray-50 p-1 px-2"
          >
            Brief📄
          </span>
        </div>
      ...
      <div>
        {content.description ? (
          <p className="bg-gray-100 mt-2 p-2 rounded-md">
            {content.description}
          </p>
        ) : null}
      </div>
