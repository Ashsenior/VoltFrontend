...
const StrategyTask = ({ data }) => {
  return (
    <a
      href="#"
      class="block my-2 p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-500 dark:bg-gray-600 "
    >
      ...
      <p className="text-md items-center flex text-gray-400 my-2">
