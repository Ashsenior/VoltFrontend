...
const InProgressStrategy = ({ data }) => {
  ...
  return (
    <a
      href="#"
      class="block my-2 p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
    >
      <Stack
        direction="row"
        alignItems={"center"}
