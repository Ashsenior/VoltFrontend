    ...
    return (
        <div className='flex items-center justify-center gap-4 bg-purple-500 text-gray-50 mx-auto w-full p-2'>
            ...
            <button
                ...
                className='btn btn-sm border-0 text-gray-300 rounded-md hover:bg-purple-600 hover:text-white bg-gray-800'><GroupAddIcon className='mr-2' />FIND candidates</button>
        </div>
    );
};
