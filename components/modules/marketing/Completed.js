  ...
  return (
    <div onClick={handleClick} className="bg-gray-900 mt-4 shadow-xl rounded-md p-4">
      <h4 className="text-lg flex font-semibold text-gray-50 pb-1 cursor-pointer">
        ...
        <span class="bg-gray-100 gap-1 ml-2 text-green-200 text-sm font-medium inline-flex items-center px-2.5 py-0.5 rounded-full mr-2 dark:bg-gray-800 dark:text-green-300">
      ...
      <div className='flex items-center mt-1'>
          ...
          <span class="bg-gray-100 gap-1 text-green-200 text-sm font-medium inline-flex items-center px-2.5 py-0.5 rounded-full mr-2 dark:bg-gray-800 dark:text-green-300">
