...
const Previews = ({ preview }) => {
  ...
  return (
    <div
      className={`bg-${preview.bg}-500 shadow-lg card my-1 rounded-2xl text-gray-500`}
    >
      <div className="flex gap-1 text-lg text-white px-4 py-2">
        <Typography className="flex flex-row gap-10 my-1 ">
          ...
          <button
            className={`px-2 leading-5 font-semibold rounded-full bg-${preview.bg}-100 text-${preview.bg}-800`}
          >
