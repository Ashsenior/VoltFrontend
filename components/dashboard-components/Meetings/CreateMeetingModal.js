      ...
      <div className="modal modal-bottom sm:modal-middle">
        <div className="modal-box bg-white">
          ...
          <div className="modal-action">
            <label htmlFor="create-meeting-modal" className="btn">
              Cancel
            </label>
            <button
              onClick={() => Router.push("/dashboards")}
              type="button"
              className="inline-flex items-center px-3 py-1 border border-transparent text-base font-large rounded-md shadow-sm text-white bg-indigo-500 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Create
            </button>
          </div>
